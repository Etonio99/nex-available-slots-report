...
const Home = (props: HomeProps) => {
    ...
    return (
        <div className="max-w-xl m-auto">
            ...
            <button onClick={click} className="text-left shadow shadow-sandstone-900/20 rounded-md border border-sandstone-300 px-4 pt-2 pb-3 hover:bg-sandstone-100 hover:-translate-y-1 transition-transform cursor-pointer">
